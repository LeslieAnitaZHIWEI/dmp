<template>
  <div class="project">
    <basic-container>
      <el-row :gutter="20">
        ...
        <el-col v-else :span="18">
          <el-row :gutter="20">
            <el-col :span="14" class="tag-table-title">
              <h3>{{ tableInfo.title }}</h3>
              <span>V {{ tableInfo.version }} </span>
              <el-tag
    effect="dark">
    {{tableInfo.calFlag==1?'模型标签':'自定义标签'}}
  </el-tag>
            ...
            <el-col :span="10" style="text-align:right">
              ...
              <el-button type="primary"  v-if="tableInfo.calFlag!=1" @click="onEditTag">
                <i class="el-icon-edit"></i> 编辑
              </el-button>
              <el-button type="warning"  v-if="tableInfo.calFlag!=1" @click="onDeleteTag" v-loading="deleteLoading">
    ...
    <el-dialog
      ...
      >
      <el-form class="tagDialog">
        <el-row  type="flex" justify="center">
         <el-col :span="2"> </el-col><el-col :span="7">
            <el-form-item label="标签名称">{{tagView.name
        }}</el-form-item>
          </el-col>
          <el-col :span="7" :offset="3">
            <el-form-item label="标签编码">{{ tagView.code}}</el-form-item>
          </el-col>
        </el-row>
         <el-row  type="flex" justify="center">
          <el-col :span="2"> </el-col><el-col :span="7">
            <el-form-item label="标签分类">{{tagView.userTagTypeName}}</el-form-item>
          </el-col>
          <el-col :span="7" :offset="3">
          
            <el-form-item label="计算方式">{{tagView.computeType==1?'手动':''}}{{tagView.computeType==0?'例行':''}}</el-form-item>
          </el-col>
        </el-row>
         <el-row  type="flex" justify="center">
          <el-col :span="2"> </el-col><el-col :span="17">
            <el-form-item label="标签类型">{{tagView.incident==1?'事件':'--'}}</el-form-item>
          </el-col>
        </el-row>
        <el-row  type="flex" justify="center">
         <el-col :span="2"> </el-col> <el-col :span="17">
            <el-form-item label="标签说明">{{tagView.content?tagView.content:'--'}}</el-form-item>
          </el-col>
        </el-row>
...
.tagDialog /deep/.el-form-item__label{
  font-weight: 700
}
