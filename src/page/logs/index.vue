<template>
  <avue-crud :data="logsList" :option="option">
    <template slot="menuLeft">
      <el-button type="primary" size="mini" icon="el-icon-upload" @click="send">上传服务器</el-button>
      <el-button type="danger" size="mini" icon="el-icon-delete" @click="clear">清空本地日志</el-button>
    </template>
    <template slot-scope="scope" slot="type">
      <el-tag type="danger" size="mini">{{ scope.label }}</el-tag>
    </template>
